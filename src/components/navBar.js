import { Navbar, Link, Text, Avatar, Dropdown, Card, Grid, Button, Divider, Container } from "@nextui-org/react";
                ...
                <Navbar shouldHideOnScroll isBordered isCompact variant="floating">
                    ...
                    >
                        <Dropdown placement="bottom-right">
                            ...
                            >
                                <Dropdown.Item key="info" css={{ height: "$18", color: '$text' }}>
                        ...
                        <Grid xs={0} sm={2} css={{
                            ...
                            <div style={{
                                ...
                                <Card css={{ placeItems: 'start' }}>
                                    ...
                                    <div
                                            key={item}>
                                        {item === 'Reports' || item === 'Log Out' ? <Divider /> : null}
                                        <Button
                                            activeColor="secondary"
                                            css={{
                                                color: index === collapseItems.length - 1 ? "$error" : "",
