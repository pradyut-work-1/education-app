...
export default function SettingsContainer({}) {
  const [font, setFont] = useState(new Set(["text"]));

  const selectedFont = useMemo(
    () => Array.from(font).join(", ").replace("_", " "),
    [font]
  );
  return (
    <>
            ...
            <Card.Body>
              <Grid.Container gap={1}>
                <Grid xs={12} justify="space-between">
                  Schedule <Switch size={"xs"} />
                </Grid>
                <Grid xs={12} justify="space-between">
                  Assignment <Switch size={"xs"} />
                </Grid>
                <Grid xs={12} justify="space-between">
                  Attendance <Switch size={"xs"} />
                </Grid>
                <Grid xs={12} justify="space-between">
                  Discussions <Switch size={"xs"} />
                </Grid>
              </Grid.Container>
            </Card.Body>
          </Card>
